                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="mb-3">
                                <a class="btn btn-link" :href="`${this.$urlPrefix}admin/attributes/`">
                            ...
                            <!-- NAV -->
                            <nav aria-label="Page navigation" v-if="attributeValues.length > 0">
                                <ul class="pagination">
...
<script>
    export default {
        ...
        created() {
            this.base_url = `${this.$urlPrefix}admin/attributes/${this.attribute_id}/values/`
            this.fetchRecords();
            this.fetchAttribute();
        },
        ...
        methods: {
            ...
            fetchAttribute() {
                let page_url = `${this.$urlPrefix}admin/attributes/${this.attribute_id}`
                axios.get(page_url)
                    .then(({data}) => {
